...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        ...
        return self.GET("search", parameters: parameters, success: { (operation: AFHTTPRequestOperation!, response: AnyObject!) -> Void in
            Business.lastResponse = response as? NSDictionary
    ...
    func searchWithTerm(term: String, parameters: Dictionary<String, String>, offset: Int = 0, limit: Int = 20,  completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        ...
        return self.GET("search", parameters: params, success: { (operation: AFHTTPRequestOperation!, response: AnyObject!) -> Void in
            Business.lastResponse = response as? NSDictionary
            var dictionaries = response["businesses"] as? [NSDictionary]
            if dictionaries != nil {
                completion(Business.businesses(array: dictionaries!), nil)
